...
public class RedBlackTree<T extends Comparable<? super T>> implements Iterable<RedBlackTree.BinaryNode> {
	...
	public class BinaryNode {
		...
		public BinaryNode removeStep2(RedBlackTree<T>.MyBoolean checkBox,
				RedBlackTree<T>.RedBlackInsertBox rotationBox) {
		...
		private BinaryNode removeStep2A(RedBlackTree<T>.MyBoolean checkBox,
				RedBlackTree<T>.RedBlackInsertBox rotationBox) {
		...
		public BinaryNode removeStep3(RedBlackTree<T>.MyBoolean checkBox,
				RedBlackTree<T>.RedBlackInsertBox rotationBox) {
		...
		private RedBlackTree<T>.BinaryNode removeStep2B(RedBlackTree<T>.MyBoolean checkBox,
				RedBlackTree<T>.RedBlackInsertBox rotationBox) {
		...
		private BinaryNode removeStep2B2(RedBlackTree<T>.MyBoolean checkBox,
				RedBlackTree<T>.RedBlackInsertBox rotationBox, int ind) {
		...
		private BinaryNode removeStep2B1(RedBlackTree<T>.MyBoolean checkBox,
				RedBlackTree<T>.RedBlackInsertBox rotationBox) {
		...
		private BinaryNode removeStep1(RedBlackTree<T>.MyBoolean checkBox,
				RedBlackTree<T>.RedBlackInsertBox rotationBox) {
			// step 1 case 1
		...
		public BinaryNode insert(RedBlackTree<T>.BinaryNode a, RedBlackTree<T>.RedBlackInsertBox box) {
		...
		private RedBlackTree<T>.BinaryNode rightRotationReform(RedBlackTree<T>.RedBlackInsertBox box) {
			// Right Rotation
		...
		private RedBlackTree<T>.BinaryNode leftRotationReform(RedBlackTree<T>.RedBlackInsertBox box) {
			box.addSingleRotation();
		...
		private boolean colorCheck(RedBlackTree<T>.RedBlackInsertBox box) {
			if (this.color == RedBlackTree.Color.RED) {
				box.addKillPoint();
		...
		private boolean hasBothRedChild() {
			if (this.hasBothChild()) {
				if (this.leftChild.color == RedBlackTree.Color.RED && this.rightChild.color == RedBlackTree.Color.RED) {
					return true;
				}
			}
			return false;
	...
	public class PreOrderLazyIterator implements Iterator {
		...
		public PreOrderLazyIterator(RedBlackTree bN) {
